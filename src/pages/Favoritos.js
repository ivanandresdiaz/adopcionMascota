  ...
  return(`
    <div class="container-fluid HomePage">
      <div class="p-3 pb-5 contenedor-body-fetch">
        <h1 class="font-weight-bold">Mascotas Favoritas  </h1>
                  ...
                  <div class="column-fetch-1 border-redondeado">
                    <a href="#/${data.idPet}/">
                      <div class="item-fetch">
                        <img class="item-fetch__img shadow" src="${data.img}" alt="favorito${index}" />
                        <div class="item-fetch__details">
                          <p class="item-fetch__name ps-2">Nombre: ${data.name.first}</p>
                          <p class="item-fetch__race ps-2">Raza: ${data.name.last}</p>
                        </div>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="margin-fetch-2">
                    <div class="column-fetch-2 border-redondeado">
                      <a href="#/${data.idPet}/">
                        ...
                        <img class="item-fetch__img shadow" src="${data.img}" alt="favorito${index}" />
                        <div class="item-fetch__details">
                          <p class="item-fetch__name ps-2 fs-6">Nombre: ${data.name.first}</p>
                          <p class="item-fetch__race ps-2 fs-6">Raza: ${data.name.last}</p>
                        </div>
                      </div>
                      </a>
      ...
      <div class="row">
        <div class="Navegador-componente col-12 d-flex bg-light justify-content-around position-fixed align-items-center">
          ...
          <div id="Nav_favoritos">
            <a class="text-decoration-none rounded-pill btn btn-primary m-1" href="#/favoritos/">
              <svg  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path class="favoriteIcon" d="M20.84 4.60999C20.3292 4.099 19.7228 3.69364 19.0554 3.41708C18.3879 3.14052 17.6725 2.99817 16.95 2.99817C16.2275 2.99817 15.5121 3.14052 14.8446 3.41708C14.1772 3.69364 13.5708 4.099 13.06 4.60999L12 5.66999L10.94 4.60999C9.9083 3.5783 8.50903 2.9987 7.05 2.9987C5.59096 2.9987 4.19169 3.5783 3.16 4.60999C2.1283 5.64169 1.54871 7.04096 1.54871 8.49999C1.54871 9.95903 2.1283 11.3583 3.16 12.39L4.22 13.45L12 21.23L19.78 13.45L20.84 12.39C21.351 11.8792 21.7563 11.2728 22.0329 10.6053C22.3095 9.93789 22.4518 9.22248 22.4518 8.49999C22.4518 7.77751 22.3095 7.0621 22.0329 6.39464C21.7563 5.72718 21.351 5.12075 20.84 4.60999V4.60999Z" stroke="#85D1CE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
