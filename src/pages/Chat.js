...
const Chat = async ()=>{
  ...
  return(`
    <div class=" vh-100">
      <div class="avatar-info bg-light pt-4">
        <div class="d-flex justify-content-center">
          <img class="rounded-circle picture-chat" src="${profile.picture.medium}" alt="avatar" />
        </div>
      ...
      <div class="d-flex flex-column align-items-end px-3">
        <div class="time d-flex justify-content-center w-100">
          <p class="m-0">4:00pm</p>
        </div>
        <div class="bg-white rounded-3 p-2 ">
          <p class="m-0"> ¡Hola! Me encantaría adoptar a Rocky.</p>
        </div>
      </div>
      <div class="d-flex flex-column align-items-start px-3">
        <div class="time d-flex justify-content-center w-100">
          <p class="m-0">4:02pm</p>
        </div>
        <div class="bg-info w-75 rounded-3 p-2 ">
          <p class="m-0">¡Hola! claro, podemos acordar un lugar y hora para que conoscas a Rocky.</p>
        </div>
      </div>
      <div class="input-chat position-fixed">
        <div class="row col-12 px-4">
            <div class="form-group">
              <input class="form-control" type="text" id="chat" placeHolder="Escribe tu mensaje" />
            </div>
          </div>
      </div>
          <!-- Navegador -->
          <div class="row">
            <div class="Navegador-componente col-12 d-flex bg-light justify-content-around position-fixed align-items-center">
              ...
              <div id="Nav_chat">
                <a class="text-decoration-none rounded-pill btn btn-primary m-1" href="#/chat/">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path class="chatIcon" d="M21 11.5C21.0034 12.8199 20.6951 14.1219 20.1 15.3C19.3944 16.7118 18.3098 17.8992 16.9674 18.7293C15.6251 19.5594 14.0782 19.9994 12.5 20C11.1801 20.0035 9.87812 19.6951 8.7 19.1L3 21L4.9 15.3C4.30493 14.1219 3.99656 12.8199 4 11.5C4.00061 9.92179 4.44061 8.37488 5.27072 7.03258C6.10083 5.69028 7.28825 4.6056 8.7 3.90003C9.87812 3.30496 11.1801 2.99659 12.5 3.00003H13C15.0843 3.11502 17.053 3.99479 18.5291 5.47089C20.0052 6.94699 20.885 8.91568 21 11V11.5Z" stroke="#85D1CE" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
