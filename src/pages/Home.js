import HomeIcon from '../assets/nav/nav_home.svg';
import ChatIcon from '../assets/nav/nav_chat.svg';
import FavoriteIcon from '../assets/nav/nav_heart.svg';
import PerfilIcon from '../assets/nav/nav_user.svg';
const Home = ()=>{
  return(`
    <div class="bg-secondary p-3 ">
      <h1 class="">Adopta una mascota Adorable </h1>
      ...
      <div className="Navegador-componente">
        <div className="Nav d-flex bg-light>
          <div id="Nav_home">
